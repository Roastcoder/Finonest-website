...
async function seedCMS() {
  ...
  try {
    ...
    const footer = {
      ...
      socialLinks: [
        { platform: 'facebook', url: 'https://facebook.com/finonest' },
        { platform: 'instagram', url: 'https://instagram.com/finonest' },
        { platform: 'linkedin', url: 'https://linkedin.com/company/finonest' },
        { platform: 'youtube', url: 'https://youtube.com/@finonest' }
      ],
      legalLinks: [
    ...
    const pages = [
      ...
      },
      {
        ...
        blocks: [
          {
            ...
            props: {
              ...
              content: 'We are your trusted financial partner, providing innovative solutions for all your financial needs.'
            }
          }
        ],
        status: 'published',
        publishedAt: new Date(),
        seo: {
          metaTitle: 'About Finonest',
          metaDescription: 'Learn more about Finonest and our financial services'
        }
      }
    ];
