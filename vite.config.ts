...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Finonest - India's Fastest Growing Loan Provider",
        short_name: "Finonest",
        description: "Get home loans, car loans, personal loans & business loans with quick approval and best rates.",
        theme_color: "#0a3055",
        background_color: "#0a3055",
        display: "standalone",
